  ...
  return <section id="about" className="about-section section-space">
    <div className="page-wrap about-layout">
      ...
      <div ref={copyRef} className="about-copy reveal">
        ...
        <div className="beyond-code"><span className="eyebrow">BEYOND THE TERMINAL</span><div><span>⚽ Varsity goalkeeper · 4 seasons</span><span>🏅 2× Presidential Scholar Athlete</span><span>🌎 National Spanish Exam · Gold / Top 5%</span></div></div>
      </div>
    </div>
  </section>
}
