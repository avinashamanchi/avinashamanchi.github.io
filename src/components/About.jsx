  ...
  return <section id="about" className="about-section section-space">
    <div className="page-wrap about-layout">
      ...
      <div className="about-copy reveal">
        ...
        <div className="beyond-code"><span className="eyebrow">BEYOND THE TERMINAL</span><div><span>⚽ Varsity goalkeeper</span><span>🏅 Presidential Athlete Award</span><span>🌎 Spanish language scholar</span></div></div>
      </div>
    </div>
  </section>
}
